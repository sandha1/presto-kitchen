...
appliance7 = Appliance.create!(name: "Fondue au chocolat", description: "Cheeseburger manchego gouda. Who moved my cheese who moved my cheese boursin roquefort ricotta caerphilly cheese and biscuits mascarpone. Cottage cheese rubber cheese red leicester rubber cheese bavarian bergkase halloumi mozzarella bocconcini. Dolcelatte.", price: 19, user: testuser1, capacity: 8, city: "Kremlin-Bicêtre")
...
appliance11 = Appliance.create!(name: "Appareil à fondue", description: "Flexitarian fit 90's JOMO ennui neutra letterpress woke lo-fi put a bird on it. Woke cloud bread tumblr fondue.", price: 15, user: testuser5, capacity: 6, city: "Orsay")
...
appliance12 = Appliance.create!(name: "Hot pot!", description: "Street art sriracha cardigan pop-up. Ennui prism jawn literally distillery vinyl crucifix af echo park quinoa slow-carb biodiesel vibecession keffiyeh. Artisan vexillologist tattooed sartorial. Authentic squid ethical, shabby chic meh williamsburg YOLO cliche viral edison bulb letterpress. Poutine viral 8-bit gastropub pinterest. Intelligentsia vice distillery salvia, mustache synth VHS banh mi yuccie adaptogen la croix.", price: 20, user: testuser3, capacity: 10, city: "Anthony")
...
appliance15 = Appliance.create!(name: "Sousvide like a boss", description: "Mollit dolore hexagon small batch ascot air plant, reprehenderit butcher consequat sriracha marxism adaptogen williamsburg iPhone. Freegan try-hard officia non. Kale chips paleo +1, mukbang tempor vape heirloom. Sustainable sunt vice leggings, four dollar toast chillwave voluptate 8-bit. Chia salvia minim dolor asymmetrical.", price: 25, user: testuser3, capacity: 2, city: "Paris")
